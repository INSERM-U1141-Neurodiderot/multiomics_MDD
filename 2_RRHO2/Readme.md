...
#### Data
We used the output *res_single_mRNA.rds* (R data object) generated by the previous mRNA single omic analysis (cf. line 192 [/1_Single_Omics/README.md](https://github.com/INSERM-U1141-Neurodiderot/multiomics_MDD/blob/main/1_Single_Omics/README.md))
```{r}

...
We used neuroComBat v1.0.5 to adjust for covariates, an improved version dedicated to CV procedures: https://github.com/Jfortin1/ComBatHarmonization/tree/master/R
...
For each jDR method and combination of blocks, a factor matrix F=f1,…, fRRn×R , representing the shared variance across blocks, was derived (where n is the number of samples and R=10 the number of factors extracted).
